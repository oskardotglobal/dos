...
const HowToPlay = () => {
    ...
    return selectedComponent || (
        <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-t from-menu-gradient-start via-menu-gradient-transition to-menu-gradient-end"
             style={{ backgroundAttachment: 'local', minHeight: '100vh', overflowY: 'auto', padding: '1em', paddingTop: '50em' }}>
            ...
            <div className="mb-5 font-MajorMonoDisplay text-white max-w-3/5">
                ...
                <p  className="mb-4">Zu Beginn des Spieles wird jeden Spieler ein Kartenstapel mit sieben zufälligen Karten ausgeteilt.
                ...
                <p className="mb-3">Bei einem Spielzug muss ein Spieler, wenn er eine passende Karte zur obersten aufgedeckten Karte auf
            ...
            <button onClick={() => setSelectedComponent(<Menu/>)}
